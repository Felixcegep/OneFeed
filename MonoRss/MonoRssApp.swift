    ...
    var sharedModelContainer: ModelContainer = {
        ...
        do {
            ...
            if ProcessInfo.processInfo.arguments.contains("-uiTesting") {
                ...
                let feedA = Feed(title: "Trail of Bits", websiteURL: URL(string: "https://example.com"), feedURL: URL(string: "https://example.com/feed")!)
                let feedB = Feed(title: "Swift.org", websiteURL: URL(string: "https://swift.org"), feedURL: URL(string: "https://swift.org/atom.xml")!)
